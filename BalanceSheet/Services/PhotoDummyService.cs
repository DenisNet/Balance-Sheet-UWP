...
namespace BalanceSheet.Services
{
    ...
    public class PhotoDummyService : IPhotoService
    {
        ...
        /// Gets the categories.
        /// </summary>
        public List<Home> Home { get; private set; }
        ...
        /// </summary>
        public List<HomePreview> TopHome { get; private set; }
        ...
        {
            List<MobileServiceAuthenticationProvider> ne = new List<MobileServiceAuthenticationProvider>();
            ne.Add(MobileServiceAuthenticationProvider.Facebook);
            ne.Add(MobileServiceAuthenticationProvider.Google);
            ne.Add(MobileServiceAuthenticationProvider.MicrosoftAccount);
            ne.Add(MobileServiceAuthenticationProvider.Twitter);
            ne.Add(MobileServiceAuthenticationProvider.WindowsAzureActiveDirectory);
            return ne;
        }
        ...
        public async Task<List<Home>> GetCategories()
        {
            await SimulateWaitAndError();
